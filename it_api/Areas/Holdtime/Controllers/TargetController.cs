...
namespace it_template.Areas.Holdtime.Controllers
{
    ...
    public class TargetController : BaseController
    {
        ...
        private UserManager<Vue.Models.UserModel> UserManager;
        public TargetController(HoldTimeContext context, IConfiguration configuration, UserManager<Vue.Models.UserModel> UserMgr) : base(context)
        {
